...
<!--content-->
		<div class="content">
			<h2>
				<img src="<?php echo IMG_URL ?>contact/mode.png" />
			</h2>
			<p>公司名称：<?php echo ($project_01["pro_company"]); ?></p>
			<p>公司地址：<?php echo ($project_01["pro_com_addr"]); ?></p>
			<p>官方网站：<?php echo ($project_01["pro_com_website"]); ?></p>
			<p>公司电话：<?php echo ($project_01["pro_com_tel"]); ?></p>
		</div>
<!--copyright-->
